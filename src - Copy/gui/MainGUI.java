...
public class MainGUI extends JFrame {
    ...
    public MainGUI() {
        ...
        if (PropertiesUtils.propertiesErrorFound()) {
            Helper.printErrln("Property file \"config.properties\" is "
                    + "missing or corrupted!");
            Helper.println("Resetting properties and creating new file...");
            PropertiesUtils.setDefaultPropertyFile();
            Helper.printErrln("Please re-enter your credentials in the settings menu!");
        } else {
            Helper.println("Settings were retrieved succesfully");
        }
        ...
        Helper.println("Gathering available databases...");
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jMessageConsolePane, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void updateDatabaseComboBoxes() {
        String[] databases = Helper.listToStringArray(_connector.getDatabases());
    ...
    private void updateTableComboBoxes() {
        if (jDatabaseComboBox.getSelectedItem() != null) {
            ...
            jTableComboBox.setModel(new DefaultComboBoxModel(Helper.
    ...
    private void jCreateDatabaseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCreateDatabaseButtonActionPerformed
        ...
        if (selectedDatabaseName.isEmpty()) {
            return;
        } else if (Helper.isIn(selectedDatabaseName, _connector.getDatabases())) {
    ...
    private void jCreateTableButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCreateTableButtonActionPerformed
        ...
        if (selectedTableName.isEmpty()) {
            return;
        } else if (Helper.isIn(selectedTableName, _currentDatabase.getTables())) {
    ...
    {//GEN-HEADEREND:event_jRunXAMPPButtonActionPerformed
        ...
        Helper.printErrln("xampp-control.exe was not found!");
        System.out.println(DASHES);
    ...
    private void jDownloadTweetsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDownloadTweetsButtonActionPerformed
        ...
        while (!isDone) {
            ...
            Helper.println(afterSize - previousSize + " tweets were downloaded.");

            if (jAutoInsertCheckbox.isSelected()) {
                Helper.println("Updating database...");
    ...
    private void jSinceDateChooserPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jSinceDateChooserPropertyChange
        ...
        if (Helper.datesAreEqual(jSinceDateChooser.getDate(), new Date())) {
    ...
    private void jTopWordsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTopWordsButtonActionPerformed
        List<String[]> wordsArrays = Helper.stringListToStringWordArray(
                _currentDatabase.getField("editedTweet", _currentTable));
        List<String[]> hashtagsArrays = Helper.stringListToStringWordArray(
